...
// 🌐 عنوان الموقع (غيّره عند ربط دومين مخصص لاحقاً)
...
export const metadata: Metadata = {
  ...
  title: {
    default: "Code Tech | كود تك - شركة برمجية متخصصة في صنعاء",
    template: "%s | Code Tech",
  },
  description:
    "شركة Code Tech البرمجية في صنعاء - نبني أنظمة برمجية بحماية فائقة ودقة عالية. تطوير مواقع الويب، تطبيقات الجوال، الأنظمة الإدارية، ومشاريع التخرج. أسعار مناسبة مع إمكانية التسديد بالأقساط.",
  ...
  openGraph: {
    ...
    url: SITE_URL,
    siteName: SITE_NAME,
    title: "Code Tech | كود تك - شركة برمجية متخصصة في صنعاء",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Code Tech - شركة برمجية في صنعاء",
      },
    ],
  },
  ...
  verification: {
    google: "", // ← ضع كود Google هنا لاحقاً
  },
...
const structuredData = {
  ...
  description:
    "شركة برمجية متخصصة في تطوير الأنظمة والتطبيقات ومواقع الويب في صنعاء، اليمن.",
  address: {
    "@type": "PostalAddress",
